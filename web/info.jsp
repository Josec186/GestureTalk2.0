        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-8"><span style="text-align: justify; font-family: Arial; font-size: 17pt;">
                    ...
                    <p><strong>Diseñadores:</strong></p>

                    <p>- Marcos Daniel Castañeda Ruiz</p>
                    <p>- Lina Alejandra Cuellar Santoyo</p>
                    <p>- Alejandra Monserrat López Flores</p>
                    <p>- Itzel Leticia Sibaja Sánchez</p>
                </div>
                <div class="col-sm-2"></div>
                <div class="row">
                    <br>
